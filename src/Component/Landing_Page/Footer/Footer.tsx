  ...
  return (
    <>
      <footer
        ...
        className="flex justify-around px-[50px] py-[50px]"
      >
        <div className="flex flex-col gap-[30px]">
          ...
          >
            <g clipPath="url(#clip0_2098_2751)">
              <path
          ...
          <div className="text-[#515251] font-[400] leading-[24px] tracking-[0.25px] text-[14px]">
        ...
        <div className="flex flex-col gap-[10px]">
          <h1 className="text-[#292A29] text-[20px] font-[600] leading-[24px] tracking-[0.2px]">
            Product
          </h1>
          <p className="text-[#515251] font-[400] leading-[24px] tracking-[0.25px] text-[14px]">
            Indidual
          </p>
          <p className="text-[#515251] font-[400] leading-[24px] tracking-[0.25px] text-[14px]">
            Businesses
        ...
        <div className="flex flex-col gap-[10px]">
          ...
          <div className="flex items-center px-[10px] h-[40px] rounded-[16px] bg-[#F2F1F1]">
            <input
              type="email"
            ...
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
            >
              <g clipPath="url(#clip0_2098_2769)">
                <path
                  fillRule="evenodd"
                  clipRule="evenodd"
