...
export const Nav: FC = () => {
  return (
    <>
      <nav className="flex justify-around items-center py-[30px] bg-[url('/src/Component/Asset/group.png')] bg-no-repeat px-[50px]">
        <div className="flex gap-[70px] items-center">
          ...
          <div>
            <ul className="flex gap-[48px] font-[500] text-[16px] leading-[24px]">
              <li>Individual</li>
              <li>Business</li>
              <li>Pricing</li>
        ...
        <div className="flex gap-[24px]">
          <button className="text-[#11453B] text-[14px] font-[500] leading-[20px] tracking-[0.1px] w-[168px] py-[10px] px-[30px] rounded-[24px] border-[1px] border-[#11453B]">Log in</button>
          <button className="text-[#fff] text-[14px] font-[500] leading-[20px] tracking-[0.1px] rounded-[24px] bg-[#11453B] w-[168px] py-[10px] px-[30px]">Register</button>
        </div>
      </nav>
    </>
  );
