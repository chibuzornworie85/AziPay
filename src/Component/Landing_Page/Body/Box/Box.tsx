...
export const Box: FC = () => {
  return (
    <>
      <div className="bg-[url('/src/Component/Asset/bg.png')] bg-no-repeat bg-cover pb-[200px] px-[50px]">
        <nav className="flex justify-around items-center py-[30px]">
          <div className="flex gap-[70px] items-center">
            ...
            <div>
              <ul
                ...
                className="flex gap-[48px] font-[500] text-[16px] leading-[24px]"
              >
                <li>Individual</li>
                <li>Business</li>
                <li>Pricing</li>
        ...
        <div className="px-[50px] w-[625px] flex flex-col gap-[72px] pt-[70px]">
          <div className="flex flex-col gap-[24px]">
            <h1
              style={{ fontFamily: "MADE Mellow PERSONAL USE" }}
              className="text-[#292A29] font-[500] text-[64px] leading-[72px]"
            >
            ...
            <p
              style={{ fontFamily: "Aeonik" }}
              className="text-[20px] font-[400] leading-[28px] w-[450px] tracking-[0.2px] text-[#515251]"
            >
            ...
            <button
              style={{ fontFamily: "Aeonik" }}
              className="color w-[272px] py-[16px] px-[36px] rounded-[32px] bg-[#11453B] text-[#fff]"
            >
          ...
          >
            <p className="text-[18px] font-[500] leading-[24px]">
              Download the Eazipay App
            </p>
            <div style={{ fontFamily: "Aeonik" }} className="flex gap-[10px]">
